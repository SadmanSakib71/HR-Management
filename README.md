...
(with photo upload), daily attendance tracking, and monthly attendance reports.
...
- A PostgreSQL 13+ database — either local Postgres or a serverless provider such as
  [Neon](https://neon.tech) (free tier is enough). You will need the connection string.
...
2. Copy example environment file and fill in your own values
